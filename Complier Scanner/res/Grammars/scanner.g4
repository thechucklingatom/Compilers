                    ...
                    while(temp.size() > 0){
                        ...
                        if(ST.get($IDENTIFIER.text).getType().matches("INT")){
                            if("+".equals(mathOperation)){
                                IRList.add(";ADDI " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }else if("*".equals(mathOperation)){
                                IRList.add(";MULTI " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }else if("\\".equals(mathOperation)){
                                IRList.add(";DIVI " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }
                        }else if(ST.get($IDENTIFIER.text).getType().matches("FLOAT")){
                            if("+".equals(mathOperation)){
                                IRList.add(";ADDF " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }else if("*".equals(mathOperation)){
                                IRList.add(";MULTF " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }else if("\\".equals(mathOperation)){
                                IRList.add(";DIVF " + temp.remove() + " " + temp.remove() + " " + $IDENTIFIER.text);
                            }
                        }
                    }
